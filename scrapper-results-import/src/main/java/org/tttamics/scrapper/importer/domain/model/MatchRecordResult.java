package org.tttamics.scrapper.importer.domain.model;
...
public class MatchRecordResult {
    ...
    public MatchRecordResult(String category, String group, String season, int day, ZonedDateTime dateTime, String local, String visitor, int localScore, int visitorScore, int localGamesWon, int visitorGamesWon, String observations) {
